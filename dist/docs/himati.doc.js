...
import * as digitalAssetController from "../controllers/digitalAsset.controller.js";
// validators
...
import { createAspirationSchema, idSchema as aspirationIdSchema } from "../validators/aspiration.validator.js";
import { createDigitalAssetSchema, updateDigitalAssetSchema, idSchema as digitalAssetIdSchema } from "../validators/digitalAsset.validator.js";
...
}), digitalAssetController.getAll);
docApp.openapi(createRoute({
    method: "get",
    path: "/api/digital-asset/{id}",
    tags: ["Digital Asset"],
    request: { params: digitalAssetIdSchema },
    responses: {
        200: { description: "Found" },
        404: { description: "Not found", content: { "application/json": { schema: errorSchema } } }
    }
}), digitalAssetController.getOne);
docApp.openapi(createRoute({
    method: "post",
    path: "/api/digital-asset",
    tags: ["Digital Asset"],
    ...
    request: {
        body: {
            content: {
                "multipart/form-data": {
                    schema: createDigitalAssetSchema.extend({
                        image: z.any().optional()
                    })
                }
            }
...
docApp.openapi(createRoute({
    ...
    security: [{ BearerAuth: [] }],
    request: {
        params: digitalAssetIdSchema,
        body: {
            content: {
                "multipart/form-data": {
                    schema: updateDigitalAssetSchema.extend({
                        image: z.any().optional()
                    })
                }
            }
